...
function printData(data) {
    ...
    listaResult.forEach(index => {
        ...
        listItemAction.textContent = `Acción: ${action}`;
        listItemCod.textContent = `Code Ticker: ${codTicker}`;
        listItemIndice.textContent = `Indice: ${indice}`;
        listItemNemo.textContent = `Nombre: ${nemo}`;
        listItemPrice.textContent = `Precio: $${price}`;
        listItemStamp.textContent = `time stamp: ${timeStamp}`;
        listItemTrade.textContent = `times trade: ${timesTrade}`;
        listItemVar.textContent = `Variación: ${variation}%`;
        listItemVol.textContent = `Volumen: ${volume}`;
